...
class MyHybridGAM(GeneticAlgorithm):
    def __init__(self,
                 pop_size=100,
    ...
    def next(self):
        ...
        self.has_terminated = (self.flag == 3) #(not self.termination.do_continue(self)) or self.mip_gap < 0.002  #self.flag
