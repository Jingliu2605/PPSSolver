...
def minimize(problem,
    ...
    gui_output :
        A GUI output object that can be used to display the results in a graphical user interface.
    ...
    if algorithm.problem is None:
        algorithm.setup(problem, termination=termination, gui_output=gui_output, **kwargs)
    else:
        if termination is not None:
            algorithm.termination = termination  # termination_from_tuple(termination)
