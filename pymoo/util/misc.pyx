...
def get_termination_options():
    ...
    #from pymoo.termination.min_igd import IGDTermination
    from pymoo.termination.x_tol import DesignSpaceToleranceTermination
    #from pymoo.termination.obj import MultiObjectiveSpaceToleranceTermination
    from pymoo.termination.so_obj_tol import SingleObjectiveSpaceToleranceTermination
    from pymoo.termination.default_termination import SingleObjectiveDefaultTermination
